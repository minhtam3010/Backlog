  ...
  return (
    <Space wrap>
      <Select
        ...
        onChange={(value) => handleProgressChange(value, getWorkload[idx])}
        options={[
          {
            value: "Not Started",
            label: "Not Started",
  ...
  return (
    <Space wrap>
      <Select
        ...
        onChange={(value) => handlePICChange(value, getWorkload[idx], myName)}
        options={option}
      />
    </Space>
  );
